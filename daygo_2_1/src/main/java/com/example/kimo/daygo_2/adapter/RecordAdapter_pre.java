 ...
 */
public class RecordAdapter_pre extends RecyclerView.Adapter<RecordAdapter_pre.ArticleViewHolder> {
    ...
    public RecordAdapter_pre(Context context, List<Result> results){
    ...
    @Override
    public RecordAdapter_pre.ArticleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(RecordAdapter_pre.ArticleViewHolder holder,final int position) {
