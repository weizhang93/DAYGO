...
import static com.example.kimo.daygo_2.R.color.menu_open;

/**
 * Created by Administrator on 2016/3/8 0008.
 */
public class RecyclerFragmentFactory extends Fragment implements View.OnClickListener {
    ...
    private static final int art_num = 20;
    public static String mType = "Android";

    public static RecyclerFragmentFactory getInstance(String title) {
        RecyclerFragmentFactory factory = new RecyclerFragmentFactory();
...
//                }
    ...
    private void loadDbData() {
        ...
        switch (mTitle) {
            ...
            case "录制":
                girl_list.clear();
                girl_list.addAll(DaoUtils.getGirl_list());
                break;
            case "记录":
                note_list.clear();
    ...
    private void dealDataInRecyclerView(List<Result> article_list, List<Result> results) {
        switch (mTitle) {
            case "资料":
                ...
                break;
            case "录制":
                girlAdapter.getResults().addAll(results);
    ...
    private void loadData(boolean isTop, String type) {
        switch (mTitle) {
            ...
            case "录制":
                ...
                getDataResults("福利", girl_num, NOW_PAGE_GIRL, isTop);
                break;
            case "记录":
                //直接从数据库中取数据
                break;
